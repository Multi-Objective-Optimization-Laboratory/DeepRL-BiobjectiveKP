...
WSM=0 #Choose one if you want the testing to be done based on the weighted sum method. Otherwise, choose zero, and in that case the testing will be done based on pseudo epsilon constraint method. Default: 1
